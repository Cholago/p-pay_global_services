...
import { ChevronDownIcon, BanknotesIcon, CreditCardIcon } from "@heroicons/vue/20/solid";
...
const navigation = [
    ...
    /*
    {
        ...
        icon: BanknotesIcon,
        current: route().current("pendingpayments"),
    },
    */
...
const userNavigation = [{ name: "Profile", href: route("profile.edit") }];

const sidebarOpen = ref(false);

const defaultUserImageUrl =  `${window._baseUrl}img/user.jpg`; // Access window here
